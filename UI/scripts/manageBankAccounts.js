...
const renderBankAccountsData = (accountsResultsInfo) => {
  ...
  for (let k = 0; k < numberOfPages; k += 1) {
    startIndex = endIndex;
...
const openNavigationPanel = () => {
  ...
  const pageFooterPanel = document.getElementById('pageFooterPanel');
  pageHeaderElement.setAttribute('class', 'inactive');
  pageFooterElement.setAttribute('class', 'inactive');
};

const closeNavigationPanel = () => {
  const pageHeaderPanel = document.getElementById('pageHeaderPanel');
  const pageFooterPanel = document.getElementById('pageFooterPanel');
  pageHeaderElement.setAttribute('class', 'pageHeader');
  pageFooterElement.setAttribute('class', 'pageFooter');
};
